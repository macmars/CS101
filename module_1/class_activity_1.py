...
"""
2) Write a program that displays the area and perimeter of a rectangle with the width of 4.5 and height of 7.9.
"""
print("\n===Problem 2===\n")
w = 4.5
h = 7.9
...
"""
3) Write a program that that solves the following equations and displays the value for x and y.
